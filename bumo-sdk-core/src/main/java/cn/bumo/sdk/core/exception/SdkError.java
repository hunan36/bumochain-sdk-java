...
public enum SdkError{
    ...
    OPERATION_ERROR_PAYMENT_COIN_ZERO(10017, "支付BU币必须大于0"),
    OPERATION_ERROR_TEST_OPER(10018, "评估操作不能为空"),
    OPERATION_ERROR_NOT_INITBALANCE(10020,"initBalance不能为零"),
    ...
    TRANSACTION_ERROR_FEE_NOT_ZERO(10109, "费用不能为零"),
